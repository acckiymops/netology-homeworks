...
4. Инициализируйте проект, выполните код. Исправьте намеренно допущенные синтаксические ошибки. Ищите внимательно, посимвольно. Ответьте, в чём заключается их суть.
   ***процессора с id standart-v4 нет на платформе, изменил на standard-v3, также выставил core = 2 и core_fraction = 20 (минимально доступные)***
5. Подключитесь к консоли ВМ через ssh и выполните команду ``` curl ifconfig.me```.

Примечание: К OS ubuntu "out of a box, те из коробки" необходимо подключаться под пользователем ubuntu: ```"ssh ubuntu@vm_ip_address"```. Предварительно убедитесь, что ваш ключ добавлен в ssh-агент: ```eval $(ssh-agent) && ssh-add``` Вы познакомитесь с тем как при создании ВМ создать своего пользователя в блоке metadata в следующей лекции.;
6. Ответьте, как в процессе обучения могут пригодиться параметры ```preemptible = true``` и ```core_fraction=5``` в параметрах ВМ.
***Полезно для экономии средств при создании ВМ без разворачивания на них высоконагруженных сервисов, а также для тестирования***

В качестве решения приложите:

- скриншот ЛК Yandex Cloud с созданной ВМ, где видно внешний ip-адрес;
<img width="1645" height="76" alt="image" src="https://github.com/user-attachments/assets/591cf439-d41c-4ae4-bda9-c149145a5acd" />

- скриншот консоли, curl должен отобразить тот же внешний ip-адрес;
<img width="346" height="50" alt="image" src="https://github.com/user-attachments/assets/977723be-fba7-4ada-a4fc-d0984bbe3a27" />
- ответы на вопросы.
