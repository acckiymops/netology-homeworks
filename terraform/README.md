...
6. Выполните код. В качестве ответа приложите: исправленный фрагмент кода и вывод команды ```docker ps```.
   <img width="482" height="425" alt="image" src="https://github.com/user-attachments/assets/73e7c600-4d0c-46e7-91ce-828c374ba980" />

   <img width="1372" height="67" alt="image" src="https://github.com/user-attachments/assets/575ae225-4550-46e4-b77d-ce29fb078bba" />
...
***Опасность заключается в том, что изменения будут применены без этапа проверки и ручного подтверждения. Полагаю, данный ключ будет полезен при использовании в скриптах автоматизации***
